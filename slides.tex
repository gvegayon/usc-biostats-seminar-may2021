...
\end{figure}
	\Large \vfill\hfill\uncover<4->{... Where is all this data?}\normalsize
\end{frame}
...
\begin{center}
	\begin{minipage}[m]{.49\linewidth}
		...
		\mode<handout>{%
			\includegraphics[width=.95\linewidth]{geese-equationlikelihood.pdf}
		}
	\end{minipage}%
\hfill %
	\begin{minipage}[m]{.49\linewidth}
...
\begin{frame}[c]
	...
	\textbf{%
		\color{uscgold}
		\Large ``GEne functional Evolution using SufficiEncy''\\\textit{or}\\GEESE\large %
	}
